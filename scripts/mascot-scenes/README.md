...
| `clipgrad` | `clipgrad <in.mp4> <out.mp4> <start> <end> <pan px> <top l,m,r> <floor l,m,r> <right t,m,b>` — a wide scene (sleep) fitted by width and panned, with flat gradient bands above, below and to the right in the film's own edge colours. The bands are Core Animation layers drawn over the film's edges, because AVFoundation antialiases every video edge against black and a stretched strip of film would show a hairline. |
...
`clipgrad … 0.13 3.04 117 bdbdbd,c5c5c5,bebcb8 d8d8d8,dddbd9,e8e7e3 bcbab6,c3c1bf,e5e4e0`
