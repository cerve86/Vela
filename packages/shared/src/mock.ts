...
export const exercises: Exercise[] = [
  {
    ...
    cues: ['Full height through the big toe', '3s lower', 'Count to fatigue, aim for 20'],
    muscleGroups: ['calves'],
    equipment: 'Step',
    videoPath: null,
    coachId: null,
  ...
  },
  {
    ...
    cues: ['Hips stay level', 'Drive through the heel', 'Ribs down'],
  ...
  },
  {
    ...
    cues: ['No hands, no momentum', 'Knee tracks over the foot'],
  ...
  },
  {
    ...
    cues: ['Leg slightly behind the hip line', 'No trunk roll'],
  ...
  },
  {
    ...
    cues: ['Exhale as you lift the pelvic floor', 'Inhale to fully release', 'Release matters as much as the lift'],
    muscleGroups: ['core'],
    equipment: 'Bodyweight',
    videoPath: null,
    coachId: COACH_ID,
  ...
  },
  {
    id: 'ex_7',
    name: 'Goblet Squat',
    cues: ['Chest tall', 'Breathe out on the way up', 'No breath holding'],
    muscleGroups: ['quads', 'glutes'],
    equipment: 'Dumbbell',
    videoPath: null,
    coachId: null,
  ...
  },
  {
    ...
    cues: ['Hinge from the hip', 'Neutral spine', 'Bar stays close'],
  ...
  },
  {
    id: 'ex_10',
    name: 'Pogo Hops',
    cues: ['Quiet landings', 'Stiff ankles, soft knees', 'Stop if anything leaks or drags'],
    muscleGroups: ['calves'],
    equipment: 'Bodyweight',
    videoPath: null,
    coachId: COACH_ID,
  ...
  },
  {
    ...
    cues: ['Run easy enough to hold a conversation', 'Walk before you feel you need to'],
  ...
  },
  {
    ...
    cues: ['Conversational pace throughout', 'Cadence light and quick'],
    muscleGroups: ['full_body'],
    equipment: 'None',
    videoPath: null,
    coachId: null,
...
/**
 * Seed roster. Every client is a real shape of this practice: women returning to
 * running and strength, most of them postpartum, at different points on the pathway
 * from early rehab to racing again.
 *
 * "_basePain" here means symptom burden rather than injury pain — for this population
 * the number that matters is usually heaviness, dragging or leaking under load.
 */
export const clients: ClientProfile[] = [
  makeClient(
    ...
    '1992-03-14',
    168,
    { deliveryType: 'vaginal', weeksPostpartum: 14, breastfeeding: true },
    'Return to running — 14 weeks postpartum',
    'Run 5k continuously, symptom-free',
    { _adherence: 0.94, _basePain: 2, _painDrift: -1.2, _startWeight: 66.4, _weightDrift: -0.9, _loadSpike: false, _inactiveDays: 0 },
  ),
  makeClient(
    'cl_2',
    'Chiara',
    ...
    '1990-07-21',
    171,
    { deliveryType: 'caesarean', weeksPostpartum: 9, breastfeeding: true },
    'C-section recovery — 9 weeks postpartum',
    'Rebuild core and lift her toddler without pain',
    { _adherence: 0.72, _basePain: 3, _painDrift: -0.8, _startWeight: 71.2, _weightDrift: -1.6, _loadSpike: false, _inactiveDays: 2 },
  ),
  makeClient(
    'cl_3',
    'Elena',
    ...
    '1988-02-09',
    165,
    { deliveryType: 'assisted_vaginal', weeksPostpartum: 22, breastfeeding: false },
    'Stress incontinence on impact — 22 weeks postpartum',
    'Run a 10k without leaking',
    { _adherence: 0.63, _basePain: 4, _painDrift: 0.4, _startWeight: 63.8, _weightDrift: -0.4, _loadSpike: false, _inactiveDays: 3 },
  ),
  makeClient(
    'cl_4',
    'Giulia',
    ...
    '1994-11-30',
    174,
    { deliveryType: 'vaginal', weeksPostpartum: 36, breastfeeding: false },
    'Return to racing — 9 months postpartum',
    'Sub-2:00 half marathon',
    { _adherence: 0.97, _basePain: 1, _painDrift: -0.3, _startWeight: 59.6, _weightDrift: 0.3, _loadSpike: true, _inactiveDays: 0 },
  ),
  makeClient(
    'cl_5',
    'Sofia',
    ...
    '1996-05-17',
    169,
    { deliveryType: 'caesarean', weeksPostpartum: 5, breastfeeding: true },
    'Early postnatal rehab — 5 weeks postpartum',
    'Walk 30 minutes comfortably, then build',
    { _adherence: 0.88, _basePain: 3, _painDrift: -1.4, _startWeight: 69.9, _weightDrift: -2.1, _loadSpike: false, _inactiveDays: 1 },
  ),
  makeClient(
    'cl_6',
    'Alice',
    ...
    '1991-09-03',
    163,
    { deliveryType: 'vaginal', weeksPostpartum: 52, breastfeeding: false },
    'Pelvic girdle pain persisting at 12 months',
    'Run three times a week pain-free',
    { _adherence: 0.55, _basePain: 5, _painDrift: 0.9, _startWeight: 64.2, _weightDrift: 0.5, _loadSpike: false, _inactiveDays: 6 },
  ),
  makeClient(
    'cl_7',
    'Beatrice',
    ...
    '1993-04-12',
    176,
    { deliveryType: 'not_applicable', weeksPostpartum: null, breastfeeding: false },
    'Strength base for first marathon',
    'Finish Milan marathon injury-free',
    { _adherence: 0.91, _basePain: 1, _painDrift: -0.2, _startWeight: 62.0, _weightDrift: -0.2, _loadSpike: false, _inactiveDays: 1 },
  ),
  makeClient(
    'cl_8',
    'Francesca',
    ...
    '1987-12-08',
    167,
    { deliveryType: 'vaginal', weeksPostpartum: 11, breastfeeding: true },
    'Diastasis recti — 11 weeks postpartum',
    'Close the gap and return to lifting',
    { _adherence: 0.79, _basePain: 2, _painDrift: -0.7, _startWeight: 68.5, _weightDrift: -1.8, _loadSpike: false, _inactiveDays: 2 },
  ),
];
...
const SESSION_TITLES = ['Strength — lower', 'Walk-run intervals', 'Pelvic floor & core', 'Strength — full body'];
...
function buildSessions(c: ClientProfile): Session[] {
  ...
  for (let d = HISTORY_DAYS; d >= 0; d--) {
    ...
    out.push({
      ...
      discipline: (['strength', 'run', 'rehab', 'strength'] as const)[d % 4] ?? 'strength',
      scheduledDate: date,
      status,
      ...
      clientNotes: done && rand() > 0.75 ? 'Felt strong today, no heaviness at all.' : null,
      coachFeedback: null,
    });
  }
  return out;
...
function buildSetLogs(c: ClientProfile, sessions: Session[]): SetLog[] {
  ...
  const out: SetLog[] = [];
  const picks = ['ex_7', 'ex_8', 'ex_9', 'ex_1', 'ex_2', 'ex_3'];
